...
d.add(11, 1, '查看个人信息', 'admin/myInfo.jsp', 'I1', 'I1');
d.add(12, 1, '修改个人信息', 'admin/modifyMyInfo.jsp', 'I1', 'I1');
d.add(13, 1, '修改密码', 'admin/modifyMyPwd.jsp', 'I1', 'I1');

d.add(2, 0, '管理员管理', '', 'I1', 'I1');
d.add(21, 2, '维护管理员', 'adminManage_adminList', 'I1', 'I1');

d.add(3, 0, '学生管理', '', 'I1', 'I1');
d.add(31, 3, '维护学生', 'studentManage_studentList', 'I1', 'I1');
