				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#f3ffe3">
								<form action="adminManage_updateAdminLogin" method="post"
									name="adForm">
									<table width="100%" border="0" align="l" cellpadding="0"
										...
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF" class="STYLE2">
												<div align="left" class="STYLE2 STYLE1">
													...
													<input type="hidden" value="${sadmin.id}" id="aid"
														name="admin.id" />
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF" class="STYLE2">
												<div align="left" class="STYLE2 STYLE1">
													&nbsp;&nbsp;
													<input type="password" name="admin.adminPwd">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF" class="STYLE2">
												<div align="left" class="STYLE2 STYLE1">
													&nbsp;&nbsp;
													<input type="password" name="admin.adminNewPwd">
												</div>
											</td>
										</tr>
										<tr>
