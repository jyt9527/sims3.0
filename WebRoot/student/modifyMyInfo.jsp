...
%>
<%
	Student st = (Student) session.getAttribute("show");
%>
<html>
	<head>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#f3ffe3">
								<form action="ManagerStudentMySelf?operator=xiugai" method="post"
									name="adForm">
									<table width="100%" border="0" align="l" cellpadding="0"
										...
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF" class="STYLE2">
												<div align="left" class="STYLE2 STYLE1">
													&nbsp;&nbsp;
													<input type="text" name="Place" value="<%=st.getPlace()%>">
												</div>
											</td>
										</tr>
										<tr>
